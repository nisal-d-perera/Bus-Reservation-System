                                ...
                                <form class="user" method="post">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <input type="text" class="form-control form-control-user" id="dri_nic" name="dri_nic"
                                                value="<?=$d_nic?>" maxlength="12" disabled="">
                                        </div>
                                        <div class="col-sm-6">
                                        ...
                                        <input type="text" class="form-control form-control-user" id="dri_dl" name="dri_dl"
                                                value="<?=$d_dl?>" maxlength="8" disabled="">
                                        </div>                                       
                                    </div>
                                    <br>
                                    <div class="form-group row">
...
if (isset($_POST['delete'])) {
    ...
    if ($sch_s=="Ongoing") {
        ...
        echo "<script>window.location.href='Change_driver.php';</script>";  
    }
}
if (isset($_POST['ok'])) {
