...
if ($_GET['tic_id']) {
    $sql = "SELECT * FROM `customer`,`user`,`schedule`,`ticket` WHERE customer.customer_no = ticket.customer_id AND ticket.sch_id = schedule.schedule_id AND user.email = customer.email AND`ticket_id`='".$_GET['tic_id']."';";
    $result = $conn->query($sql);
    $row = $result->fetch_assoc();
                                        ...
                                        <div class="col-lg-6">
                                            <div class="p-5">
                                                ...
                                                <form method="POST">
                                                    ...
                                                    <div class="mb-3">
                                                        <h5>Change Status : 
                                                        <select name="tic_status" id="tic_status" required="">
                                                            <option value="" ></option>
                                                            <option value="Confirm">Confirm</option>
                                                            <option value="Expire">Expire</option>
                                                        </select></h5>
                                                    </div>
                                                    <input type="submit" class="btn btn-success" value="Change" id="submit" name="submit">
...
if (isset($_POST['submit'])) {
    ...
    $sql="UPDATE `ticket` SET `tic_status` = '$tic_status' WHERE `ticket`.`ticket_id` = '$tic_id'";
    $conn->query($sql);
    
    echo "<script>alert('Successfully Changed');document.location='Ticket.php'</script>";
...
if (isset($_POST['delete'])) {
    ...
    if ( $tic_status == "Expire"){

        $sql="DELETE FROM `ticket` WHERE ticket.ticket_id = '$tic_id'";
        $conn->query($sql);
    
        echo "<script>alert('Successfully Deleted');document.location='Ticket.php'</script>";
    }
    else{
        echo "<script>alert('Cannot delete!');document.location='Ticket.php'</script>";
    }
